...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, groups, collision_sprites, semi_collision_sprites):
        ...
        self.image = pygame.image.load(join('..', 'graphics', 'player.png'))
    ...
    def input(self):
        ...
        if not self.timers['wall jump'].active:
            ...
            if keys[pygame.K_DOWN]:
                self.timers['platform skip'].acivate()
    ...
    def check_contact(self):
        ...
        top_rect = pygame.Rect(self.hitbox_rect.topleft + vector(0,-2),(self.hitbox_rect.width,2))
    ...
    def semi_collision(self):
        "Метод обрабатывает ситуацию, когда игрок находится на платформме"
